...
const ItemCard = ({
  ...
  return (
    <Card className="group relative mx-auto h-[320px] w-full max-w-[260px] min-w-0 overflow-hidden border border-border/50 shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:shadow-xl">
